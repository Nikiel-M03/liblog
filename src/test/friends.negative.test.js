...
import { sendFriendRequest, acceptFriendRequest, rejectFriendRequest, getPendingRequests, getAcceptedFriends, removeFriend, } from '@/services/friends';
...
describe('Friends service - Negative Tests', () => {
    ...
    describe('sendFriendRequest - Negative Cases', () => {
        it('should throw error when user not found', async () => {
            ...
            await expect(sendFriendRequest('user1', 'nonexistent@example.com')).rejects.toThrow('User not found');
        });
        it('should throw error when friendship already exists', async () => {
            ...
            await expect(sendFriendRequest('user1', 'user2@example.com')).rejects.toThrow('Friendship request already exists');
        });
        it('should throw error when friend request insert fails', async () => {
            ...
            await expect(sendFriendRequest('user1', 'user2@example.com')).rejects.toThrow('Insert failed');
        });
    ...
    describe('acceptFriendRequest - Negative Cases', () => {
        it('should throw error when friendship not found', async () => {
            ...
            await expect(acceptFriendRequest('nonexistent-id')).rejects.toThrow('Friendship not found');
        });
        it('should throw error when update fails', async () => {
            ...
            await expect(acceptFriendRequest('friendship1')).rejects.toThrow('Update permission denied');
        });
    ...
    describe('rejectFriendRequest - Negative Cases', () => {
        it('should throw error when delete fails', async () => {
            ...
            await expect(rejectFriendRequest('friendship1')).rejects.toThrow('Delete permission denied');
        });
        it('should throw error when friendship not found for rejection', async () => {
            ...
            await expect(rejectFriendRequest('nonexistent-id')).rejects.toThrow('No rows deleted');
        });
    });
    describe('getPendingRequests - Negative Cases', () => {
        ...
        it('should throw error with invalid user ID', async () => {
            ...
            await expect(getPendingRequests('invalid-id')).rejects.toThrow('Invalid user ID format');
        });
    });
    ...
    describe('removeFriend - Negative Cases', () => {
        ...
        it('should throw error when friendship not found', async () => {
            ...
            await expect(removeFriend('nonexistent-id')).rejects.toThrow('No friendship with that ID');
        });
    });
