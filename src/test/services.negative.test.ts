...
describe('Services - Negative Tests', () => {
  ...
  describe('Logs service - Negative Cases', () => {
    it('should throw error when adding log fails', async () => {
      ...
      await expect(addLog('user1', { date: '2024-01-15', start_time: '09:00', end_time: '10:00', duration_minutes: 60 })).rejects.toThrow(
        'Database error',
      )
    })
  ...
  describe('Auth service - Negative Cases', () => {
    ...
    it('should throw error when profile creation fails', async () => {
      ...
      await expect(signUp('test@example.com', 'password123', 'Test User')).rejects.toThrow(
        'Failed to set display name: Profile insert failed',
      )
    })
  ...
  describe('Integration - Cross-service Negative Cases', () => {
    ...
    it('should throw error with proper message format from DB', async () => {
      ...
      await expect(
        addLog('user1', { date: '2024-01-15', start_time: '09:00', end_time: '10:00', duration_minutes: 60 }),
