...
function DashboardPage() {
    ...
    return (_jsx("div", { className: "min-h-screen bg-gray-100 py-8 px-4", children: _jsxs("div", { className: "max-w-7xl mx-auto space-y-6", children: [_jsxs("div", { className: "flex justify-between items-center", children: [_jsx("h1", { className: "text-4xl font-bold", children: "Dashboard" }), _jsxs("p", { className: "text-lg text-gray-600", children: ["Welcome, ", profile?.display_name ? profile.display_name : user?.email, "!"] })] }), _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [_jsx(Card, { title: "Total Hours", children: _jsxs("p", { className: "text-3xl font-bold text-blue-600", children: [hours.totalHours, _jsxs("span", { className: "text-lg text-gray-600 ml-2", children: ["h ", hours.remainingMinutes, "m"] })] }) }), _jsxs(Card, { title: "Current Streak", children: [_jsx("p", { className: "text-3xl font-bold text-purple-600", children: streak }), _jsx("p", { className: "text-sm text-gray-600 mt-2", children: "days" })] }), _jsxs(Card, { title: "Sessions", children: [_jsx("p", { className: "text-3xl font-bold text-green-600", children: logs.length }), _jsx("p", { className: "text-sm text-gray-600 mt-2", children: "total logged" })] })] }), _jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-6", children: [_jsx(LogForm, { onSubmit: handleAddLog }), _jsx("div", { className: "lg:col-span-2", children: _jsx(LogList, { logs: logs }) })] })] }) }));
}
